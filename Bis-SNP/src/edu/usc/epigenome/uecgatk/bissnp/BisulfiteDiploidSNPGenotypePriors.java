...
public class BisulfiteDiploidSNPGenotypePriors implements GenotypePriors {
	...
	public boolean isTransition(byte base, byte ref) {
		...
		switch (ref) {
		case BaseUtils.A:
			transition = base == BaseUtils.G ? true : false;
			break;
		case BaseUtils.G:
			transition = base == BaseUtils.A ? true : false;
			break;
		case BaseUtils.C:
			transition = base == BaseUtils.T ? true : false;
			break;
		case BaseUtils.T:
			transition = base == BaseUtils.C ? true : false;
			break;
		default:
