...
public class CytosinePatternsUserDefined {
	...
	private THashMap<String, CytosineParameters> contexts;
	/**
	 * 
	 */
	...
	public CytosinePatternsUserDefined(List<String> cytosineContextsAcquired, BisulfiteEnums.MethylSNPModel sequencingMode) {
		...
		contexts = new THashMap<String, CytosineParameters>();
	 ...
	 * @return
	 */
	public THashMap<String, CytosineParameters> getContextDefined() {
		return contexts;
	}
