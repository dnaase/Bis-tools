...
public class BisulfiteContextsGenotypeLikelihoods {
	...
	private THashSet<String> cytosineContexts;
	private THashMap<String, CytosineParameters> cytosineParameters;
	private int goodReadsCov = 0;
	private THashMap<Integer, double[]> GPsAfterCytosineTenGenotypes;
	private double[] GPsAtCytosineNormalizedByThreeGenotypes;
	private THashMap<String, Double[]> GPsAtCytosineTenGenotypes;
	private THashMap<Integer, double[]> GPsBeforeCytosineTenGenotypes;
	...
	public BisulfiteContextsGenotypeLikelihoods(String sample, Allele A, Allele B, double log10aaPosteriorLikelihoods, double log10abPosteriorLikelihoods, double log10bbPosteriorLikelihoods,
			THashSet<String> cytosineContexts, int numOfCReadsInBisulfiteCStrand, int numOfTReadsInBisulfiteCStrand, int numOfOtherReadsInBisulfiteCStrand, int numOfGReadsInGenotypeGStrand,
			int numOfAReadsInGenotypeGStrand, int numOfOtherReadsInGenotypeGStrand, int totalDepth, THashMap<String, CytosineParameters> cytosineParameters, String bestMatchedCytosinePattern,
	...
	public THashMap<String, CytosineParameters> getCytosineParameters() {
	...
	public THashMap<Integer, double[]> getGPsAfterCytosineTenGenotypes() {
		return GPsAfterCytosineTenGenotypes;
	}

	public THashMap<String, Double[]> getGPsAtCytosineTenGenotypes() {
		return GPsAtCytosineTenGenotypes;
	}

	public THashMap<Integer, double[]> getGPsBeforeCytosineTenGenotypes() {
	...
	public void setGPsAfterCytosineTenGenotypes(THashMap<Integer, double[]> GPsAfterCytosineTenGenotypes) {
		this.GPsAfterCytosineTenGenotypes = GPsAfterCytosineTenGenotypes;
	}

	public void setGPsBeforeCytosineTenGenotypes(THashMap<Integer, double[]> GPsBeforeCytosineTenGenotypes) {
		this.GPsBeforeCytosineTenGenotypes = GPsBeforeCytosineTenGenotypes;
	}
