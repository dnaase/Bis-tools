			...
			for (DiploidGenotype g : DiploidGenotype.values()) {
				...
				if (!negStrand) {
					if (BaseUtils.basesAreEqual(observedBase, BaseUtils.C)) {
						...
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error) : (g.base1 == BaseUtils.C ? pOfBase1
								...
								* (error / 3.0));
						likelihood += observedBase == g.base2 ? pOfBase1 * (1.0 - error) : (g.base2 == BaseUtils.C ? pOfBase2
					...
					if (BaseUtils.basesAreEqual(observedBase, BaseUtils.G)) {
						...
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error) : (g.base1 == BaseUtils.G ? pOfBase1
								...
								* (error / 3.0));
						likelihood += observedBase == g.base2 ? pOfBase1 * (1.0 - error) : (g.base2 == BaseUtils.G ? pOfBase2
	...
	protected BisulfiteDiploidSNPGenotypeLikelihoods getCalculateGenotypeLikelihoodsNonDirectional(byte observedBase, byte qualityScore, boolean negStrand) {
		...
		try {
			...
			for (DiploidGenotype g : DiploidGenotype.values()) {
				double likelihood = 0.0;
				if (!negStrand) {
					if (BaseUtils.basesAreEqual(observedBase, BaseUtils.C) || BaseUtils.basesAreEqual(observedBase, BaseUtils.G)) {
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error)
								* ((1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_POS) * (1.0 - BISULFITE_CONVERSION_RATE) + DETERMINED_CYTOSINE_TYPE_C_METHY_POS * (1.0 - OVER_CONVERSION_RATE)) : pOfBase1
								* (error / 3.0);
						likelihood += observedBase == g.base2 ? pOfBase2 * (1.0 - error)
					...
					} else if (BaseUtils.basesAreEqual(observedBase, BaseUtils.T) || BaseUtils.basesAreEqual(observedBase, BaseUtils.A)) {
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error) : (g.base1 == BaseUtils.C || g.base1 == BaseUtils.G ? pOfBase1
								* (error / 3.0 + (1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_POS) * BISULFITE_CONVERSION_RATE + DETERMINED_CYTOSINE_TYPE_C_METHY_POS * OVER_CONVERSION_RATE) : pOfBase1
								* (error / 3.0));
						likelihood += observedBase == g.base2 ? pOfBase1 * (1.0 - error) : (g.base2 == BaseUtils.C || g.base2 == BaseUtils.G? pOfBase2
								* (error / 3.0 + (1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_POS) * BISULFITE_CONVERSION_RATE + DETERMINED_CYTOSINE_TYPE_C_METHY_POS * OVER_CONVERSION_RATE) : pOfBase2
								* (error / 3.0));
					...
					if (BaseUtils.basesAreEqual(observedBase, BaseUtils.G) || BaseUtils.basesAreEqual(observedBase, BaseUtils.C)) {
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error)
								* ((1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_NEG) * (1.0 - BISULFITE_CONVERSION_RATE) + DETERMINED_CYTOSINE_TYPE_C_METHY_NEG * (1.0 - OVER_CONVERSION_RATE)) : pOfBase1
								* (error / 3.0);
						likelihood += observedBase == g.base2 ? pOfBase2 * (1.0 - error)
					...
					} else if (BaseUtils.basesAreEqual(observedBase, BaseUtils.A) || BaseUtils.basesAreEqual(observedBase, BaseUtils.T)) {
						likelihood += observedBase == g.base1 ? pOfBase1 * (1.0 - error) : (g.base1 == BaseUtils.G || g.base1 == BaseUtils.C ? pOfBase1
								* (error / 3.0 + (1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_NEG) * BISULFITE_CONVERSION_RATE + DETERMINED_CYTOSINE_TYPE_C_METHY_NEG * OVER_CONVERSION_RATE) : pOfBase1
								* (error / 3.0));
						likelihood += observedBase == g.base2 ? pOfBase1 * (1.0 - error) : (g.base2 == BaseUtils.G || g.base2 == BaseUtils.C ? pOfBase2
								* (error / 3.0 + (1.0 - DETERMINED_CYTOSINE_TYPE_C_METHY_NEG) * BISULFITE_CONVERSION_RATE + DETERMINED_CYTOSINE_TYPE_C_METHY_NEG * OVER_CONVERSION_RATE) : pOfBase2
								* (error / 3.0));
						if (VERBOSE) {
							// System.out.println("flag9: observedBase-" +
