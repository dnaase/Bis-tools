...
public class BbForwardBackwardScaledCalculator{
	 ...
	 * @param hmm
	 */
	public BbForwardBackwardScaledCalculator(ArrayList<ObservationMethy> oseq, Hmm<ObservationReal> hmm) {
	...
	computeAlphaInit(Hmm<ObservationReal> hmm, ObservationMethy observationMethy, int i)
	{
	...
	protected <O extends Observation> void 
	computeAlphaStep(Hmm<ObservationReal> hmm, O observation, int t, int j)
	{
		double sum = 0.;
	...
	protected <O extends Observation> void
	computeAlpha(Hmm<ObservationReal> hmm, ArrayList<ObservationMethy> oseq)
	{	
	...
	computeProbability(ArrayList<ObservationMethy> oseq, Hmm<ObservationReal> hmm)
	{	
		lnProbability = 0.;
