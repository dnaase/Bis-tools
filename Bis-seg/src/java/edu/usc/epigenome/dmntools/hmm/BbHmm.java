...
public class BbHmm<O extends Observation> extends Hmm {
	...
	public OpdfBetaBinomial getOpdf(int stateNb, int trials)
	{
		
		return new OpdfBetaBinomial(trials, ((OpdfBeta)super.getOpdf(stateNb)).alpha(),  ((OpdfBeta)super.getOpdf(stateNb)).beta());
	}
