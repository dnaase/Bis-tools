...
mainTitle=paste(prefix,"smooth:", smooth," \n-numElemCenterToAlign:",numElemGch," -totalFeatureUnderCurve:",sumFeature," -totalFeature:",numFeature)
...
title(mainTitle, cex.main = 0.6, font.main= 4, col.main= "black",xlab="Distance to elements (bp)", ylab=legendName)
legend("topright",legendName, col=line_color,lty=1,cex=1.2,lwd=2)
abline(v=0)
dev.off()
